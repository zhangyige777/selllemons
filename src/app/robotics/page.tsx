...
const pageData = getPageBySlug('robotics')

export const metadata: Metadata = generateSEOMetadata({
  title: 'Sell Lemons Robotics - Complete Guide',
...
export default function RoboticsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <Breadcrumbs items={[{ label: 'Sell Lemons Robotics Guide' }]} />
      <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Sell Lemons Robotics Guide</h1>
      <p className="text-gray-600">Learn about the Robotics system in Sell Lemons.</p>
